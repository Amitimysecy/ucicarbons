        ...
        <div class="g2" style="align-items:start;gap:48px">
            ...
            <div class="contact-form-wrap">
                ...
                <div class="contact-tabs">
                    <a href="<?php echo esc_url( home_url('/contact/') ); ?>" class="contact-tab active">Contact Us</a>
                ...
                <div style="padding:32px">
                    <div id="cform-contact-success" style="display:none;text-align:center;padding:48px 20px">
                        <div style="font-size:40px;margin-bottom:16px">✓</div>
                        <div style="font-size:20px;font-weight:800;color:var(--dark);margin-bottom:8px">Message sent.</div>
                        <p style="font-size:15px;color:var(--soft)">Thank you. We'll respond within 24 hours.</p>
                    </div>
                    <form id="cform-contact" onsubmit="uciSubmitForm(event,'cform-contact','cform-contact-success')" novalidate>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-input" name="application">
                                <option value="">Select application...</option>
                                <option>Water Treatment</option>
                                <option>Pharma / API Purification</option>
                                <option>Gold Recovery</option>
                                <option>Food &amp; Beverage</option>
                                <option>Edible Oil Refining</option>
                                <option>Air &amp; VOC Control</option>
                                <option>Gas Masks / CBRN</option>
                                <option>Oil Refining / Merox</option>
                                <option>Sugar Refining</option>
                                <option>Other / Not sure</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Message</label>
                            <textarea class="form-input" name="message" placeholder="Tell us about your requirement — volume, specification, timeline..."></textarea>
                        </div>
                        <button type="submit" class="btn-primary" style="width:100%;padding:14px;font-size:15px;text-align:center">Send enquiry →</button>
                    </form>
                </div>
            </div>
    ...
    <div class="wrap">
        <div class="pai-inner">
            ...
            <div class="pai-input-row">
                <input type="text" id="paiInput-contact" class="pai-input" placeholder="e.g. I need carbon for removing chloramine from drinking water..." onkeydown="if(event.key==='Enter')aiAskFromPage('paiInput-contact')">
                <button class="pai-btn" onclick="aiAskFromPage('paiInput-contact')">Ask AI →</button>
            </div>
        </div>
    </div>
</section>
